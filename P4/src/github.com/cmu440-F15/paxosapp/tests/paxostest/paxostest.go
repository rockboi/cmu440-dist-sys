...
import (
	...
	"github.com/cmu440-F15/paxosapp/tests/proxy"
)
...
func main() {
	btests := []testFunc{
		{"testSingleProposerSingleProposal", testSingleProposerSingleProposal},
		{"testSingleProposerUpdateKey", testSingleProposerUpdateKey},
		{"testGetNextProposalNumber", testGetNextProposalNumber},
		{"testMultipleSequentialProposers", testMultipleSequentialProposers},
	}
